...
export default function ConfirmModal({
  ...
  const getIconBackground = () => {
    switch (type) {
      ...
      default:
        return 'bg-gray-100 dark:bg-[#0a0a0a]';
    }
  };
      ...
      >
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
          ...
          <div className="px-6 py-4 bg-gray-50/50 dark:bg-gray-800/50">
            ...
            <button
              onClick={onClose}
                className="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0a0a0a] hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 hover:shadow-sm"
            >
              {cancelText}
            </button>
            <button
