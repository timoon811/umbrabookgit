    ...
    <div className="flex-1 flex flex-col bg-white dark:bg-gray-900" data-documentation-editor="true">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          {/* Левая часть - статус и поля ввода */}
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              <input
                ...
                className="text-xl font-semibold text-gray-900 dark:text-white bg-transparent border-none outline-none w-full focus:ring-2 focus:ring-blue-500 focus:bg-gray-50 dark:focus:bg-gray-800 rounded px-2 py-1 transition-colors"
              ...
              <input
                ...
                className="text-sm text-gray-600 dark:text-gray-400 bg-transparent border-none outline-none w-full focus:ring-2 focus:ring-blue-500 focus:bg-gray-50 dark:focus:bg-gray-800 rounded px-2 py-1 transition-colors"
          ...
          <div className="flex flex-wrap items-center gap-2 lg:gap-3">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <span className={`text-xs font-medium ${hasUnsavedChanges ? 'text-orange-600 dark:text-orange-400' : 'text-green-600 dark:text-green-400'}`}>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                  selectedPage.isPublished
                    ? 'text-orange-600 hover:text-orange-700 bg-orange-50 hover:bg-orange-100 dark:bg-orange-900/20 dark:text-orange-400 dark:hover:text-orange-300'
                    : 'text-green-600 hover:text-green-700 bg-green-50 hover:bg-green-100 dark:bg-green-900/20 dark:text-green-400 dark:hover:text-green-300'
                }`}
            ...
            <button
              ...
              className="flex items-center justify-center w-9 h-9 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
            ...
            {onDeletePage && (
              <button
                ...
                className="flex items-center justify-center w-9 h-9 text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/20 rounded-lg transition-colors"
