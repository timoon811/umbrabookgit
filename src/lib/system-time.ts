 ...
 * 
 * ПРИНЦИП: Везде используем ТОЛЬКО Стамбульское время (Europe/Istanbul)
 * - База данных: всегда Стамбульское время 
 * - Отображение: Стамбульское время (пользователи в Стамбуле)
 * - Логика: Стамбульское время
 * 
...
export function formatSystemTime(date: Date | string, format: 'full' | 'date' | 'time' | 'datetime' = 'datetime'): string {
  ...
  const options: Intl.DateTimeFormatOptions = {
    timeZone: 'Europe/Istanbul', // Стамбульское время
  };
